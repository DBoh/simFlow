...
# Kommentare SimFlow
#
# CfdOF Preferences Page
# To run from GUI: FreeCAD - Edit - Preferences - CfdOf

# OpenFoam install directory, Install OpenFoam
# ParaView executable path, Install ParaView
