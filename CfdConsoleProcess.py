...
# Kommentare SimFlow
#
# Klasse um Output Errors in der FreeCAD Console zu schreiben und sauberes Schließen in Linux und Windows zu gewährleisten
# Standart Fehlertexte in OpenFoam werden in die Console übersetzt
# import aus CfdTools
#
# Input:
# Output: console output/ errors
#
# ***************************************************************************
