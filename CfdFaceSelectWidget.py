...
# Kommentare SimFlow
#
# Klasse um Objekt von Referenzliste zu wählen
# Hinzufügen oder entfernen von selektierten Objekten zur Referenzliste
# Ausgabe geänderter Werte
# FaceList erstellen
# Hinzufügen eines Selection Sub - Elements
#
# Input: CfdFluidBoundary, CfdMeshRefinement, CfdZone
# Output:
#
# ***************************************************************************
