...
# Kommentare SimFlow
#
# FreeCadGui wird importiert
# Erstellung eines Cfd Analysis Gruppenobjektes.
# Hinzufügen einses Physics-Objekts bei der Erstellung eines  Cfd Analysis Objektes
# Hinzufügen von Flüssigkeitseigenschaften
# Hinzufügen eines Initialissierungsobjekts
# Hinzufügen eines Solver Objekts
# View Provider für das Cfd Analyysis Containeer Object (Teile transparent machen um Grenz Bedingungen und Zell Zonen klar sichtbar zu machen)
#
# Input:
# Output: CfdResidualPlot.py
#
# ***************************************************************************
