...
# Kommentare SimFlow
#
# Residual Plot ist ein Diagramm (DE: Partieller Residuenplot)
# Als Residuum wird die Abweichung eines durch ein mathematisches Modell
# vorhergesagten Wertes vom tatsächlich Wert bezeichnet
#
# Input: analysis_obj
# Output:
#
