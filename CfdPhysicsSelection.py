...
# PhysicsModel
#
# Import von addObjectProperty Methode von CfdTools um das "Objekte" PhysicsModel zu erzeugen
# Erzeugt  die Objekteigenschaften und legt den default fest (Funktion: initProperties)
#       "Time" mit den Werten [Steady, Transiet]
#       "Flow" [Incompressible, Compressible, HighMachCompressible]
#       "Thermal" [None, Energy]
#       "Phase" [Singe, FreeSurface]
#       "Turbulence" [Inviscid, Laminar, RANS, LES]
#       "TurbulenceModel" [kOmegaSST, kEpsilon, SpalartAllmaras, kOmegaSSTLM, kEqn, Smagorinsky, WALE]
#       "gx" Eingabefeld mit default 0 m/s^2
#       "gy" Eingabefeld mit default -9.81 m/s^2
#       "gz" Eingabefeld mit default 0 m/s^2
# Importiert und initialisieren die Klasse _TaskPanelCfdPhysicsSelection
#
# ***************************************************************************
